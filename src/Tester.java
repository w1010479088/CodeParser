...
public class Tester {
    public static void main(String[] args) {
        new BasePage() {
            ...
            protected void action(String path) {
                new CodeParser(path, CodeType.NEW.pattern(), CodeType.NEWMore.pattern(), new CodeParser.OnParseListener() {
                    @Override
                    public void onStart() {
                        log("解析开始!");
                    }
    ...
    public enum CodeType {
        ...
        NEWMore("11:29:22输入367，完成时间2秒", Pattern.compile("11:29:(\\d+)输入(\\d+)，完成时间(\\d+)秒")),
        ;
